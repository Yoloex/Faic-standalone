...
class Scrollbar_y:
    ...
    def resize_scrollbar(self, event):  # on window updates
        ...
        self.middle_of_handle = self.scrollbar_canvas.create_rectangle(
            x1, y1, x2, y2, fill="grey25", outline=""
        )
...
class Button:
    def __init__(
        ...
        if style_level == 1:
            ...
            self.button_style = style.button_swap
...
class TextSelection:
    def __init__(
        ...
        for mode in self.default_data[self.name + "Modes"]:
            ...
            self.textselect_label[mode] = tk.Label(
                self.ts_frame,
                self.sel_off_style,
                text=mode,
                image=self.blank,
            ...
            self.textselect_label[mode].bind(
                "<ButtonRelease-1>",
                lambda event, mode=mode: self.select_ui_text_selection(mode),
            )
...
class Switch2:
    def __init__(
        ...
        # Toggle Switch
        self.switch = tk.Label(
            self.switch_frame,
            style.parameter_switch_3,
            image=self.icon_off,
            width=toggle_width,
            height=self.height,
        )
...
class Slider2:
    def __init__(
        ...
        self.handle = self.slider.create_oval(
            self.oval_x1,
            self.oval_y1,
            self.oval_x2,
            self.oval_y2,
    ...
    def entry_input(self, event):
        ...
        try:
            ...
            print("Update failed with {}".format(e))
            return
