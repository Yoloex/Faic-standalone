...
####### Middle Frame  
    ...
    # Videos    
      # Found Faces
        ...
        self.widget['FindFacesButton'] = GE.Button(button_frame, 'FindFaces', 2, self.find_face, None, 'control', x=0, y=0, width=112, height=33)
        self.widget['SwapFacesButton'] = GE.Button(button_frame, 'SwapFaces', 4, self.toggle_swap, None, 'control', x=0, y=33, width=112, height=33)
    ...
    ### Parameter Window Canvas ###
        ...
        parameters_canvas = tk.Frame(canvas, style.canvas_frame_label_3, bd=0, width=width, height=600)
        ...
        self.widget['CameraSourceSel'] = GE.TextSelection(parameters_canvas, 'CameraSourceSel', 'Camera Source', 3, self.update_data, 'parameter', 'parameter', 398, 20, 1, row, 0.62)
            ...
            if success:
                try:
                    ...
                    if ret:
                        ...
                        self.target_faces[last_index]["TKButton"] = tk.Button(self.found_faces_canvas, style.media_button_on_3, height = 86, width = 86)
